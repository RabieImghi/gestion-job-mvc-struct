                            ...
                            <nav class="header-menu" data-content="mainNav">
                                ...
                                <ul class="menu-btns">
                                    ...
                                    if(isset($_SESSION['idUser'])){
                                        ?>
                                    <li>
                                        <a href="index.php?route=log_out" class="btn btn-primary btn-lg">logout</a>
                                    </li>
                                        <?php
                                    }else{
                                        ?>
                        ...
                        <div class="row flex-lg-row-reverse align-items-center justify-content-between g-gs">
                            <div class="col-lg-6 mb-n3 mb-lg-0">
                                <div class="header-image header-image-s2">
                                    <img src="user/images/header/gfx-b.png" alt="">
                                </div><!-- .header-image -->
                            </div><!-- .col- -->
                        ...
                        <div class="row align-items-center g-gs">
                            <div class="col-4 col-md-2">
                                <div class="brand-item">
                                    <img src="user/images/brand/brand-a.png" alt="">
                                </div>
                            </div><!-- .col -->
                            <div class="col-4 col-md-2">
                                <div class="brand-item">
                                    <img src="user/images/brand/brand-b.png" alt="">
                                </div>
                            </div><!-- .col -->
                            <div class="col-4 col-md-2">
                                <div class="brand-item">
                                    <img src="user/images/brand/brand-c.png" alt="">
                                </div>
                            </div><!-- .col -->
                            <div class="col-4 col-md-2">
                                <div class="brand-item">
                                    <img src="user/images/brand/brand-d.png" alt="">
                                </div>
                            </div><!-- .col -->
                            <div class="col-4 col-md-2">
                                <div class="brand-item">
                    ...
                    <div class="row align-items-center justify-content-lg-between g-gs">
                        <div class="col-lg-5">
                            <div class="img-block img-block-s1 left">
                                <img src="user/images/gfx/a.png" alt="img">
                            </div><!-- .img-block -->
                        </div><!-- .col -->
                        <div class="col-lg-6">
                    ...
                    <div class="row flex-row-reverse align-items-center justify-content-between g-gs">
                        <div class="col-lg-5">
                            <div class="img-block img-block-s1 right">
                                <img src="user/images/gfx/b.png" alt="img">
                            </div><!-- .img-block -->
                        </div><!-- .col -->
                        <div class="col-lg-6">
            ...
            <section class="section section-feature">
                <div class="container">
                    <div class="row align-items-center justify-content-between g-gs">
                        <div class="col-lg-5">
                            <div class="img-block img-block-s1 left">
                                <img src="user/images/gfx/c.png" alt="img">
                            </div>
                        </div><!-- .col -->
                        <div class="col-lg-6">
                            <div class="text-block">
                                    ...
                                    <div class="review review-s2">
                                        <div class="review-portrait review-portrait-s1">
                                            <div class="portrait portrait-s1">
                                                <img src="user/images/client/client-a.png" alt="">
                                            </div>
                                        </div>
                                        <div class="review-content">
                                            <div class="review-rating rating rating-sm">
                            ...
                            <div class="card card-shadow round-xl">
                                <div class="card-inner card-inner-lg">
                                    <div class="review review-s2">
                                        <div class="review-portrait review-portrait-s1">
                                            <div class="portrait portrait-s1">
                                                <img src="user/images/client/client-b.png" alt="">
                                            </div>
                                        </div>
                                        <div class="review-content">
                                            <div class="review-rating rating rating-sm">
